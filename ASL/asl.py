...
def asl_get_datasets(data, load_train=False, load_test=False):
    ...
    if load_train:
        ...
        train_dataset = ASL(img_dir=os.path.join(data_dir, "asl", "train"), transform=train_transform)
    else:
        train_dataset = None
    ...
    if load_test:
        ...
        test_dataset = MemesDataset(img_dir=os.path.join(data_dir, "asl", "test"), transform=test_transform)
